    ...
    <section className="min-h-screen pb-16">
      ...
      <div className="container mx-auto px-4 pb-12">
        ...
        {Object.keys(groupedProducts).map((categorySlug) => (
          ...
          >
            {/* Category Header */}
            <h3 className="text-3xl font-bold text-red-600 mb-6 border-l-4 border-red-600 pl-4">
              <Link
              ...
              <span className="text-red-500 text-base font-semibold ml-2">
            ...
            >
              {groupedProducts[categorySlug].map((product) => (
                <motion.div key={product.id} variants={itemVariants}>
                  ...
                  >
                    <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden h-full flex flex-col border-t-4 border-red-600">
