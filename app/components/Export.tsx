...
export default function Export() {
  return (
    <section className=" text-gray-900 w-full text-center py-12">
      <div className="container mx-auto px-4">
        ...
        <Link
          href="/contact"
          className="inline-flex items-center bg-red-500 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:bg-indigo-600 hover:scale-105 transition-all duration-300 text-lg"
        >
